...
public class CBPlaces extends CBMaps implements IMapDelegate{
     ...
     * @see cbedoy.cbway.lib.CBPlaces getPlaces(double, double, int, String, String, maps.java.CBPlaces.Rankby, java.util.ArrayList)
     * @see cbedoy.cbway.lib.CBPlaces getPlaceReview(String)
     * @see cbedoy.cbway.lib.CBPlaces getPhoto(String, int)
     * 
     */
    ...
    protected void onError(URL urlRequest, String status, Exception ex) {
        super.storageRequest(urlRequest.toString(), "CBPlaces request", status, ex);
    }
     ...
     * @see cbedoy.cbway.lib.CBPlaces.Rankby
     * @see cbedoy.cbway.lib.CBPlaces#getPhotosReference()
     * @see cbedoy.cbway.lib.CBPlaces#getPlacesDetails(String)
     * @see cbedoy.cbway.lib.CBPlaces#getPlaceReview
     */
    public String[][] getPlaces(double latitude, double longitude,int radius,String keyword,String namePlace,
        ...
        try {
            ...
            this.storeInfoRequest(url, "CBPlaces request", this.getStatus(xpath, document), null);
            return result;
        } catch (Exception e) {
    ...
    public String[] getPlacesDetails(String referencePlace) throws UnsupportedEncodingException, MalformedURLException{
        ...
        try {
            ...
            this.storeInfoRequest(url, "CBPlaces details request", this.getStatusDetails(xpath, document), null);
            return result;
    ...
    public String[][] getPlaceReview(String referencePlace) throws UnsupportedEncodingException, MalformedURLException{
        ...
        try {
            ...
            this.storeInfoRequest(url, "CBPlaces review request", this.getStatusDetails(xpath, document), null);
