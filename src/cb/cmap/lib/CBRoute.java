 ...
 * ---------CODE && MUSIC ----------------------------------
 */
public class CBRoute extends CBMaps {
     ...
     * @see CBRoute getRoute(String, String, java.util.ArrayList, Boolean, maps.java.CBRoute.mode, maps.java.CBRoute.avoids)
     */
    ...
    protected void onError(URL urlRequest, String status, Exception ex) {
        super.storageRequest(urlRequest.toString(), "CBRoute request", status, ex);
    }
    ...
    protected void storeInfoRequest(URL urlRequest, String info, String status, Exception exception) {
        super.storageRequest(urlRequest.toString(), "CBRoute request", status, exception);
    }
    ...
    private URL createURL(String originAddress, String destinationAddress, ArrayList<String> waypoints,
        ...
        String avoid="";
        String s = avoidsRoad.toString();
        if (s.equals("nothing")) {
            avoid = "";

        } else if (s.equals("tolls")) {
            avoid = "&avoid=tolls";

        } else if (s.equals("highways")) {
     ...
     * @see CBRoute#getCopyright()
     * @see CBRoute#getSummary()
     * @see CBRoute#getTotalDistance()
     * @see CBRoute#getTotalTime()
     * @see CBRoute#getWaypointIndex()
     * @see CBRoute.mode
     * @see CBRoute.avoids
     */
